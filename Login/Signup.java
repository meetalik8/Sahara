...
public class Signup extends javax.swing.JFrame {
    ...
    private void btnsignupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsignupActionPerformed
		...
		"Male":rb2.isSelected()?"Female":"Other";
            ...
            String sql = "select * from SignUp where name='"+name+"'and mobile_no ='"+mobile_no+"'and username='"+username+"'and password ='"+password+"'and gender ='"+gender+"'and address ='"+address"'");
