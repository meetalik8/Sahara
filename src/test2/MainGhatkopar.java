...
public class MainGhatkopar extends javax.swing.JFrame {

    private final Set<MyWaypoint> waypoints = new HashSet<>();
    private EventWaypoint event;

    public MainGhatkopar() {
        initComponents();
        init();
    }
    ...
    private void init() {
        ...
        GeoPosition geo = new GeoPosition(19.0851533,72.9087895);
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(MainGhatkopar.this, waypoint.getName());
            }
        };
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainGhatkopar().setVisible(true);
            }
        });
    }
