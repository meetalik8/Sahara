...
public class MainKanjurmarg extends javax.swing.JFrame {

    private final Set<MyWaypoint> waypoints = new HashSet<>();
    private EventWaypoint event;

    public MainKanjurmarg() {
        initComponents();
        init();
    }
    ...
    private void init() {
        ...
        GeoPosition geo = new GeoPosition(19.1285291,72.9297614);
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(MainKanjurmarg.this, waypoint.getName());
            }
        };
    }
    ...
    private void cmdAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddActionPerformed
        ...
        //addWaypoint(new MyWaypoint("Fauziya Hospital, Kurla", event ,new GeoPosition(19.08011306361458, 72.88010860533561)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainKanjurmarg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainKanjurmarg().setVisible(true);
            }
        });
    }
