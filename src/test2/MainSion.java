...
public class MainSion extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        GeoPosition geo = new GeoPosition(19.0461994,72.8681641);
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(MainSion.this, waypoint.getName());
            }
        };
    }
