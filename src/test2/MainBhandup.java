...
public class MainBhandup extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        GeoPosition geo = new GeoPosition(19.150902,72.9405184);
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(MainBhandup.this, waypoint.getName());
            }
        };
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainBhandup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainBhandup().setVisible(true);
            }
        });
    }
