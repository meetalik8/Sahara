...
public class MainJogeshwari extends javax.swing.JFrame {

    private final Set<MyWaypoint> waypoints = new HashSet<>();
    private EventWaypoint event;

    public MainJogeshwari() {
        initComponents();
        init();
    }
    ...
    private void init() {
        ...
        GeoPosition geo = new GeoPosition(19.1388874,72.8568922);
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(MainJogeshwari.this, waypoint.getName());
            }
        };
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainJogeshwari().setVisible(true);
            }
        });
    }
