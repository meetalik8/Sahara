...
public class MainMumbaicentral extends javax.swing.JFrame {

    private final Set<MyWaypoint> waypoints = new HashSet<>();
    private EventWaypoint event;

    public MainMumbaicentral() {
        initComponents();
        init();
    }
    ...
    private void init() {
        ...
        GeoPosition geo = new GeoPosition(18.9697654,72.8175699);
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(MainMumbaicentral.this, waypoint.getName());
            }
        };
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainMumbaicentral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainMumbaicentral().setVisible(true);
            }
        });
    }
