...
public class MainBandra extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        GeoPosition geo = new GeoPosition(19.0568598,72.8366675);
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(MainBandra.this, waypoint.getName());
            }
        };
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainBandra().setVisible(true);
            }
        });
    }
