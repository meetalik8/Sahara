...
public class MainVileparle extends javax.swing.JFrame {

    private final Set<MyWaypoint> waypoints = new HashSet<>();
    private EventWaypoint event;

    public MainVileparle() {
        initComponents();
        init();
    }
    ...
    private void init() {
        ...
        GeoPosition geo = new GeoPosition(19.1080117,72.8452302);
    ...
    private EventWaypoint getEvent() {
        return new EventWaypoint() {
            ...
            public void selected(MyWaypoint waypoint) {
                JOptionPane.showMessageDialog(MainVileparle.this, waypoint.getName());
            }
        };
    }
    ...
    private void cmdAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddActionPerformed
        ...
        addWaypoint(new MyWaypoint("Cooper Municipal Hospital, Juhu", event ,new GeoPosition(19.108078743099735, 72.83619078184178)));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainVileparle().setVisible(true);
            }
        });
    }
